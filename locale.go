...
func setDefaultLocaleStrings() {
	locale.Put("en_GB", "message.player.connect", "%s joined the server")
	locale.Put("en_GB", "message.player.disconnect", "%s left the server")

	locale.Put("en_GB", "command.error.unknown", "Error: Unknown command %s")
	locale.Put("en_GB", "command.error.parse", "Error: %s")
	...
	locale.Put("en_GB", "command.error.player", "Player '%s' not found")

	locale.Put("en_GB", "command.usage.command", "Command usage for: /%s")
	...
	locale.Put("en_GB", "command.usage.player", "[Player]")
